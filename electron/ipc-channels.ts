...
export const PREVIEW_HARD_RELOAD = 'minnow:preview:hard-reload';
...
export const PREVIEW_COPY_URL = 'minnow:preview:copy-url';
export const PREVIEW_COPY_SCREENSHOT = 'minnow:preview:copy-screenshot';
export const PREVIEW_GET_ZOOM = 'minnow:preview:get-zoom';
export const PREVIEW_SET_ZOOM = 'minnow:preview:set-zoom';
export const PREVIEW_CLEAR_HISTORY = 'minnow:preview:clear-history';
export const PREVIEW_CLEAR_COOKIES = 'minnow:preview:clear-cookies';
export const PREVIEW_CLEAR_CACHE = 'minnow:preview:clear-cache';
...
export const SHELL_START_FILE_DRAG = 'minnow:shell:start-file-drag';
export const SHELL_FILE_DRAG_ENDED = 'minnow:shell:file-drag-ended';
