...
4. Write plan via `save_file` with this exact schema — the plan is parsed, not interpreted, and a wrong heading or missing field is rejected with a line number:
   ```
   ---
