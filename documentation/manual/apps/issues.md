...
The header keeps **Workspace scope**, search, and **New issue** together. The secondary toolbar beside the saved views holds List/Board, Group, Files, Sync all when GitHub sync is enabled, and quick capture.
